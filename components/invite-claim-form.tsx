...
export function InviteClaimForm({ action, error }: InviteClaimFormProps) {
        ...
        if (!response.ok) {
          ...
          switch (data.error) {
            ...
            case "password_too_short":
              ...
              break;
            case "invalid_invite":
              setFormError("This invite is invalid, expired, or has already been claimed.");
              break;
            default:
              setFormError("Invite claim failed.");
          }
